...
def get_ipc_setup_commands(s3manager, instance_ids):
    from xidiansmpc.preprocessing import PreProcessedElements
    from xidiansmpc.preprocessing import PreProcessingConstants as Constants
        ...
        instance_commands = [
            [
                ...
                [
                    f"sudo docker run\
                -p {port}:{port} \
                -v /home/ubuntu/config:/usr/src/xidiansMPC/config/ \
                -v /home/ubuntu/sharedata:/usr/src/xidiansMPC/sharedata/ \
                -v /home/ubuntu/benchmark-logs:/usr/src/xidiansMPC/benchmark-logs/ \
